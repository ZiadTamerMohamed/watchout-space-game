...
Plane_IMG = pygame.transform.scale(pygame.image.load("redplane.png"), (WIDTH, HEIGHT))

PLAYER_WIDTH, PLAYER_HEIGHT = 150,200
PLAYER = pygame.Rect(200, HEIGHT - PLAYER_HEIGHT, PLAYER_WIDTH, PLAYER_HEIGHT)
PLAYER_IMG = pygame.transform.scale(pygame.image.load("redplane.png"), (PLAYER_WIDTH, PLAYER_HEIGHT))
...
def draw(player, elapsed_time, disabilities, player_name):
    ...
    WIN.blit(Plane_IMG, (player.x,player.y))
